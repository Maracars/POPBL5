		...
		<li class="dropdown messages-menu"><a class="dropdown-toggle"
			...
			<ul class="dropdown-menu dropdown-user">
				<s:if test="%{#session.user != null}">
					<li><s:a action="%{'u/' + #session.user.username}"
							namespace="/">
							<i class="fa fa-user fa-fw"></i>
							<s:text name="global.userProfile" />
						</s:a></li>
					<li><a href="#"><i class="fa fa-gear fa-fw"></i> <s:text
								name="global.settings" /></a></li>
					<s:if test="%{#session.user instanceof domain.model.users.Admin}">
						<li><s:a action="accountManager" namespace="/">
								<i class="fa fa-group fa-fw"></i>
								<s:text name="global.accountManager" />
							</s:a></li>
					</s:if>
					<li class="divider"></li>
				...
				<li><a class="center-block"
					href="https://www.codacy.com/app/Maracars/POPBL5?utm_source=www.github.com&amp;utm_medium=referral&amp;utm_content=Maracars/POPBL5&amp;utm_campaign=Badge_Grade">
						...
						src="https://api.codacy.com/project/badge/Grade/4924993f790f4bd584d0c8516d553a9b" />
				</a></li>
			</ul> <!-- /.dropdown-user --></li>
		<!-- /.dropdown -->
