			...
			<s:form action="createPlaneSubmit" namespace="/airline"
				...
				<div class="well">
					...
					<s:if test="%{!getListPlaneModel().isEmpty()}">
						<s:select list="listPlaneModel" listKey="id"
							listTitle="airline.selectPlaneModel" listValue="name"
							label="airline.selectPlaneModel" labelSeparator=":"
							name="planeModel.id"></s:select>
					</s:if>
					<s:else>
