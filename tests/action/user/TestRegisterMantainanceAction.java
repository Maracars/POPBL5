...
public class TestRegisterMantainanceAction {
	...
	public void prepareTests() {
		...
		la = Mockito.spy(new RegisterMantainanceAction());
	...
	public void testExecuteOK() {
		...
		la.user = new Mantainance(la.user);
		((Mantainance) la.user).setBirthDate(new Date());
		((Mantainance) la.user).setAddress(Initializer.initAddress());
