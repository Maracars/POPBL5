...
import action.NextArrivingFlightJSONAction;
...
public class TestNextArrivingFlightJSONAction {
	...
	NextArrivingFlightJSONAction naAction;
	...
	public void testExecuteNullData() {
		...
		naAction = new NextArrivingFlightJSONAction();
		...
		assertEquals(JSON_DATA_EMPTY_ERROR, JSON_DATA_EMPTY_LENGTH, naAction.getData().size());
	}
	...
	public void testExecuteNotNullData() {
		...
		assertEquals(JSON_DATA_NOT_EMPTY_ERROR, JSON_DATA_NOT_EMPTY_LENGTH, naAction.getData().size());
